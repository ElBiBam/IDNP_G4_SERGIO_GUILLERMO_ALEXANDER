package com.practica02.alexander_luna.adapter;
...
import com.practica02.alexander_luna.R;
import com.practica02.alexander_luna.WordData;
...
public class WordListAdapter extends ArrayAdapter<WordData> {
    ...
    public void setFragment(WordListFragment wordListFragment)
    {
            ...
            if (mediaPlayer == null) {
                ...
                try {
                    try{
                        ...
                        wordListFragment.mediaPlayer = mediaPlayer;
                    }catch(IOException e){
